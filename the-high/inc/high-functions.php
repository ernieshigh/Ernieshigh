...
function high_breadcrumbs() {
    ...
    if( is_archive() )
    {
        if (    is_category()
			...
			if($taxonomy == 'seal_type'){
				...
				$seal = '<a href="/product-datasheet/?lang=' . ICL_LANGUAGE_CODE .'">' . __('Product Datasheets', 'the-high' ) . '</a>';
			}
    ...
    if ( is_paged() ) {
        ...
        $page_addon   = $before . sprintf( __( ' ( Page %s )' ), number_format_i18n( $current_page ), 'the-high' ) . $after;
    }
