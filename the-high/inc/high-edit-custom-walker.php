 ...
 * @since 3.0.0
 *
 * This is a modified copy of the Walker Nav Menu Edit adds custom mega
 * field to menu items in the menu editor
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
	            ...
	            <p class="field-custom description description-wide">
	                <label for="edit-menu-item-mega-<?php echo $item_id; ?>">
	                    <?php _e( 'Mega Field' ); ?><br />
	                    <textarea id="edit-menu-item-mega-<?php echo $item_id; ?>" class="widefat edit-menu-item-mega" rows="3" cols="20"  name="menu-item-mega[<?php echo $item_id; ?>]"><?php echo esc_html( $item->mega ); // textarea_escaped ?></textarea>
	                </label>
	            </p>
	            <?php
